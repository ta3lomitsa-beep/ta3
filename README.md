تفضل، هذا هو الكود الكامل (HTML و CSS) لتصميم الموقع بناءً على الصورة التي أرسلتها. لقد قمت بكتابة الكود ليكون ملفاً واحداً ليسهل عليك نسخه وتشغيله مباشرة.

لقد استخدمت خط "Tajawal" من جوجل ليعطي طابعاً عربياً عصرياً، واستخدمت ألواناً احترافية (الأزرق الملكي والأبيض).

### طريقة الاستخدام:
1. قم بإنشاء ملف جديد على جهازك وسمّه `index.html`.
2. انسخ الكود التالي بالكامل وضعه داخل الملف.
3. احفظ الملف وافتحه عبر المتصفح.
